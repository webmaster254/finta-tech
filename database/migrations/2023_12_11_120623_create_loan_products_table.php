...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('loan_products', function (Blueprint $table) {
            ...
            $table->bigInteger('administration_fees_chart_of_account_id')->unsigned()->nullable();
            $table->bigInteger('insurance_chart_of_account_id')->unsigned()->nullable();
            $table->bigInteger('sms_charges_chart_of_account_id')->unsigned()->nullable();
            $table->bigInteger('loan_extension_fees_chart_of_account_id')->unsigned()->nullable();
            $table->bigInteger('penalties_chart_of_account_id')->unsigned()->nullable();
            $table->bigInteger('bad_debts_provision_chart_of_account_id')->unsigned()->nullable();
            $table->bigInteger('write_offs_chart_of_account_id')->unsigned()->nullable();
            $table->bigInteger('recovered_written_off_chart_of_account_id')->unsigned()->nullable();
            $table->bigInteger('interest_due_chart_of_account_id')->unsigned()->nullable();
            $table->bigInteger('interest_paid_chart_of_account_id')->unsigned()->nullable();
            $table->text('name');
