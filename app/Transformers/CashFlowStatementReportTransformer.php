...
class CashFlowStatementReportTransformer extends SummaryReportTransformer
{
    ...
    private array $summaryOverviewHeaders = [];
    private array $overviewHeaders = [];
    public function getPdfView(): string
    {
        return 'components.reports.cash-flow-statement-pdf';
    }
    ...
    {
        return $this->overviewHeaders ??= array_reduce($this->getColumns(), function (array $headers, Column $column): array {
    ...
    {
        return $this->summaryOverviewHeaders ??= array_diff_key($this->getOverviewHeaders(), array_flip(['account_code']));
    }
