...
class TransactionObserver
{
    ...
    public function deleting(Transaction $transaction): void
    {
        DB::transaction(static function () use ($transaction) {
            $transaction->journalEntries()->each(fn (JournalEntries $entry) => $entry->delete());
        });
    }
    ...
    private function createJournalEntries(Transaction $transaction, ChartOfAccount $debitAccount, ChartOfAccount $creditAccount): void
    {
        $convertedTransactionAmount = $this->getConvertedTransactionAmount($transaction);
    ...
    private function updateJournalEntriesForTransaction(JournalEntries $journalEntry, ChartOfAccount $account, string $convertedTransactionAmount): void
    {
