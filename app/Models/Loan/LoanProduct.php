...
class LoanProduct extends Model
{
    ...
    protected $fillable = [
        ...
        'fees_receivable_chart_of_account_id',
        'fees_chart_of_account_id',
        'overpayments_chart_of_account_id',
        'suspended_income_chart_of_account_id',
        'income_from_interest_chart_of_account_id',
        'income_from_penalties_chart_of_account_id',
        'income_from_fees_chart_of_account_id',
        'income_from_recovery_chart_of_account_id',
        'losses_written_off_chart_of_account_id',
        'interest_written_off_chart_of_account_id',
        'decimals',
