...
class ClientOfficersArrears extends BaseWidget
{
    public function table(Table $table): Table
    {
        return $table->extremePaginationLinks()
            ->poll('10s')
            ...
            ->query(Loan::query() ->where('loans.loan_officer_id', '=', auth()->user()->id)->join('loan_repayment_schedules', 'loan_repayment_schedules.loan_id', '=', 'loans.id')
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('payments')
                    ...
                    ->getStateUsing(function (Loan $record) {
                        return $record->getDaysInArrears($record->id);
                    })
