...
class UpdateTransaction
{
    ...
    /**
     * A function that recursively compares two multi-dimensional arrays and returns the differences.
     *
     * @param array $array1 The first multi-dimensional array to compare
     * @param array $array2 The second multi-dimensional array to compare against
     * @return array The differences between the two arrays
     */
    public function compare_multi_dimensional_array($array1, $array2)
    {
        $result = array();
     ...
     * Handle the event.
     */
    public function handle(LoanRepayment $event): void
    {
        $loan = $event->loan;
        $data=$event->data;
